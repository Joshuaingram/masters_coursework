...
sandwiches <- read_csv("/Users/joshuaingram/Main/Projects/masters_coursework/teaching_assistant/dealing_with_data_ii/HW2/CarbonFootprintSandwiches.csv")

eyewitness <- read_csv("/Users/joshuaingram/Main/Projects/masters_coursework/teaching_assistant/dealing_with_data_ii/HW2/EyewitnessTestimony.csv")
```
...
survey <- read_csv("/Users/joshuaingram/Main/Projects/masters_coursework/teaching_assistant/dealing_with_data_ii/HW2/ClassSurvey.csv")
```
...
### d. Find the conditional distribution of political view, given gender identity. Obtain a side-by-side bar chart in R.
...
The proportion of guilty verdicts for jurors that were presented with strong eyewitness testimony is 1.34 percentage points higher than guilty verdicts for jurors that were presented with strong eyewitness testimony. This is only 1.065 times higher, which is not a considerable difference.
...
This is not true. The proportion of jurors watching the strong testimony is 1.88 *percentage points* higher than the proportion of jurors watching the recording of the weak testimony. Stated alternatively, the proportion of jurors watching the strong testimony is $\frac{0.5093834 - 0.4906166}{0.4906166}  \times 100 = 3.83$% (*percent*) higher than the proportion of jurors watching the recording of the weak testimony.
...
plot(sandwiches$`EnergyContent (kCal)`, sandwiches$`Carbon footprint (g CO2 eq.)`,
     main = "Relationship Between Sandwich Energy Content and Carbon Footprint",
...
ggplot(data=sandwiches,
  ...
  labs(title = "Relationship Between Sandwich Energy Content and Carbon Footprint")
```
...
The relationship between a sandwiches energy content and its carbon footprint is a moderately strong positive relationship with a correlation coefficient of 0.621. As the energy content of the sandwich increases, we expect to observe an increase in the carbon footprint to produce the sandwich.